...
2) Go to the `Data Science Projects` section and access your application's project named `quarkus-feb24-1`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `quarkus-feb24-1-notebook`.
...
5) In the terminal, run `cd quarkus-feb24-1` to navigate to your sample app's directory.
